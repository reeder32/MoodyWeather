...
//    }
    ...
    func setupConstraints() {
        ...
        colorSquare.widthAnchor.constraint(equalToConstant: 24).isActive = true
        colorSquare.heightAnchor.constraint(equalToConstant: 24).isActive = true
        colorLabel.topAnchor.constraint(equalTo: self.topAnchor, constant: 0).isActive = true
        colorLabel.bottomAnchor.constraint(equalTo: self.bottomAnchor, constant: -8).isActive = true
