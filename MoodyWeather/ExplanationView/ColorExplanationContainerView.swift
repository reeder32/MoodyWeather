...
class ColorExplanationContainerView: UIView {
    lazy var tense: ColorExplanationView = {
        let label = ColorExplanationView(color: .tenseColor, text: "Tense")
        return label
    }()
    lazy var anxious: ColorExplanationView = {
        let label = ColorExplanationView(color: .anxiousColor, text: "Anxious")
        return label
    }()
    lazy var nervous: ColorExplanationView = {
        let label = ColorExplanationView(color: .nervousColor, text: "Nervous")
        return label
    }()
    lazy var average: ColorExplanationView = {
        let label = ColorExplanationView(color: .averageColor, text: "Average")
        return label
    }()
    lazy var charged: ColorExplanationView = {
        let label = ColorExplanationView(color: .chargedColor, text: "Charged")
        return label
    }()
    lazy var relaxed: ColorExplanationView = {
        let label = ColorExplanationView(color: .relaxedColor, text: "Relaxed")
        return label
    }()
    lazy var happy: ColorExplanationView = {
        let label = ColorExplanationView(color: .happyColor, text: "Very Happy")
        return label
    }()
